...
class LeaveCommentComponent extends Component
{
    ...
    public function init()
    {
        ...
        $this->context['commentFormArgs'] = array(
          ...
          'class_submit' => 'w-full px-4 py-2 text-base font-medium rounded-md shadow-sm text-white bg-pink-600 hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500',
        );
    }
